...
import Preview from './Components/Accounts/Dashboard/AddBlog/Preview';
...
function App() {
  ...
  useEffect(() => {
    const getBlogsData = async () => {
      ...
      localStorage.setItem("blogsData",JSON.stringify(data.docs.map((doc) => ({ ...doc.data(), id: doc.id }))))
    }
    getBlogsData()
      ...
      <UserAuthContextProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route exact path="/dashboard/createBlog" element={<ProtectedRoute><Loader><AddBlog /></Loader></ProtectedRoute>} />
            <Route exact path="/dashboard/createBlog/preview" element={<ProtectedRoute><Loader><Preview /></Loader></ProtectedRoute>} />

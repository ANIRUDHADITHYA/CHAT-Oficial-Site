...
const DeleteBlog = () => {
    ...
    const handleDelete = async () => {
        const blogDoc = doc(db, "Blogs", deleteBlog);
                                            ...
                                            <CardActionArea>
                                                <CardContent>
                                                    ...
                                                    <div className="blogCardFlex">
                                                        ...
                                                        <Typography gutterBottom variant="h5" component="div">
                                                            <button onClick={() => { setDeleteBlog(false) }}>No</button>
                                                        </Typography>
                                                    </div>
                                                </CardContent>
                                            </CardActionArea>
                                ...
                                <div className="blog-card-section">
                                    {userBlogs ?
                                        ...
                                        userBlogs.map((blog, index) => (
                                            ...
                                            <Link to={"#"} className="blog-card-wrap">
                                                <Card key={index} className="blogs-box">
                                                    ...
                                                    <CardActionArea className="recent-blog-links">
                                                        ...
                                                        <CardContent>
                                                            ...
                                                            <Typography gutterBottom variant="h5" component="div">
                                                                <button className="deleteBlogButton" onClick={() => { setDeleteBlog(blog.blog_id) }}>Delete Blog</button>
                                                            </Typography>
                                                        </CardContent>
                                                    </CardActionArea>
